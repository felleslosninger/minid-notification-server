class minid_notification_server (
  ...
  String $nets_ciba_oidc_provider           = $minid_notification_server::params::nets_ciba_oidc_provider,
  String $nets_ciba_client_id               = $minid_notification_server::params::nets_ciba_client_id,
  String $nets_ciba_client_secret           = $minid_notification_server::params::nets_ciba_client_secret,
