...
//                .csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse()) // TODO: check me
            ...
            .and()
                .authorizeRequests()
                .antMatchers("/info", "/version", "/health", "/prometheus", "/favicon.ico", "/v3/api-docs", "/v3/api-docs/swagger-config", "/swagger-ui/**", "/swagger-ui/index.html", "/swagger-ui.html", "/api/onboarding/**","/api/app/versions", "/api/internal/**", "/api/attestation/**", "/api/register/passport/**")
                .permitAll()
            .and()
