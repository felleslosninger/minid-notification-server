...
@Component
public class NetsRestTemplate extends RestTemplate {

    public NetsRestTemplate(@Autowired(required = false) DeveloperLoggingRequestInterceptor loggingInterceptor,
